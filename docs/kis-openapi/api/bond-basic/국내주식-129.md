...
장내채권 기본조회 API for [장내채권] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTPF1114R` |
...
```
GET /uapi/domestic-bond/v1/quotations/search-bond-info
```
...
| `tr_id` | `CTPF1114R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTPF1114R`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 장내채권 기본조회.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-bond/v1/quotations/search-bond-info"
