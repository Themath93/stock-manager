...
선물옵션 잔고현황 API for [국내선물옵션] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTFO6118R` |
| Paper Trading | `VTFO6118R` |


## Endpoint

```
GET /uapi/domestic-futureoption/v1/trading/inquire-balance
```
...
| `tr_id` | `CTFO6118R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTFO6118R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTFO6118R`, Paper: `VTFO6118R`) | Yes |
