...
선물옵션기간약정수수료일별 API for [국내선물옵션] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTFO6119R` |
...
```
GET /uapi/domestic-futureoption/v1/trading/inquire-daily-amount-fee
```
...
| `tr_id` | `CTFO6119R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTFO6119R`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 선물옵션기간약정수수료일별.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-futureoption/v1/trading/inquire-daily-amount-fee"
