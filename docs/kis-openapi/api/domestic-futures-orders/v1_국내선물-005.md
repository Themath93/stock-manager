...
선물옵션 주문가능 API for [국내선물옵션] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTO5105R` |
| Paper Trading | `VTTO5105R` |


## Endpoint

```
GET /uapi/domestic-futureoption/v1/trading/inquire-psbl-order
```
...
| `tr_id` | `TTTO5105R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTO5105R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTO5105R`, Paper: `VTTO5105R`) | Yes |
