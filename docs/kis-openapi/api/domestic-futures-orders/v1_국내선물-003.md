...
선물옵션 주문체결내역조회 API for [국내선물옵션] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTO5201R` |
| Paper Trading | `VTTO5201R` |


## Endpoint

```
GET /uapi/domestic-futureoption/v1/trading/inquire-ccnl
```
...
| `tr_id` | `TTTO5201R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTO5201R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTO5201R`, Paper: `VTTO5201R`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 선물옵션 주문체결내역조회.
