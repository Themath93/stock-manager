...
선물옵션 시세호가 API for [국내선물옵션] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHMIF10010000` |
| Paper Trading | `FHMIF10010000` |
...
| `tr_id` | `FHMIF10010000` | Conditional | TR_ID for real trading |
| `tr_id` | `FHMIF10010000` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHMIF10010000`, Paper: `FHMIF10010000`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 선물옵션 시세호가.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-futureoption/v1/quotations/inquire-asking-price"
