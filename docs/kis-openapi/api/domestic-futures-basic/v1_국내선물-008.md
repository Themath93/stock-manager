...
선물옵션기간별시세(일/주/월/년) API for [국내선물옵션] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKIF03020100` |
| Paper Trading | `FHKIF03020100` |
...
| `tr_id` | `FHKIF03020100` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKIF03020100` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKIF03020100`, Paper: `FHKIF03020100`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 선물옵션기간별시세(일/주/월/년).

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-futureoption/v1/quotations/inquire-daily-fuopchartprice"
...
[Back to [국내선물옵션] 기본시세](../index.md) | [API Documentation Index](../../index.md)