...
ELW 현재가 시세 API for [국내주식] ELW 시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKEW15010000` |
| Paper Trading | `FHKEW15010000` |
...
| `tr_id` | `FHKEW15010000` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKEW15010000` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKEW15010000`, Paper: `FHKEW15010000`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to ELW 현재가 시세.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-stock/v1/quotations/inquire-elw-price"
...
[Back to [국내주식] ELW 시세](../index.md) | [API Documentation Index](../../index.md)