...
ELW LP매매추이 API for [국내주식] ELW 시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHPEW03760000` |
...
```
GET /uapi/elw/v1/quotations/lp-trade-trend
```
...
| `tr_id` | `FHPEW03760000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHPEW03760000`, Paper: ``) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to ELW LP매매추이.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/elw/v1/quotations/lp-trade-trend"
