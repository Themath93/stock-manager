...
해외선물옵션 실시간주문내역통보 API for [해외선물옵션]실시간시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HDFFF1C0` |
...
| `tr_id` | `HDFFF1C0` | Conditional | TR_ID for real trading |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 해외선물옵션 실시간주문내역통보.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/tryitout/HDFFF1C0"
...
[Back to [해외선물옵션]실시간시세](../index.md) | [API Documentation Index](../../index.md)