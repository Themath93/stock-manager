...
해외주식 종목/지수/환율기간별시세(일/주/월/년) API for [해외주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST03030100` |
| Paper Trading | `FHKST03030100` |
...
| `tr_id` | `FHKST03030100` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST03030100` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST03030100`, Paper: `FHKST03030100`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 해외주식 종목/지수/환율기간별시세(일/주/월/년).

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/overseas-price/v1/quotations/inquire-daily-chartprice"
...
[Back to [해외주식] 기본시세](../index.md) | [API Documentation Index](../../index.md)