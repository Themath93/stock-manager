...
해외주식 기간별시세 API for [해외주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHDFS76240000` |
| Paper Trading | `HHDFS76240000` |
...
| `tr_id` | `HHDFS76240000` | Conditional | TR_ID for real trading |
| `tr_id` | `HHDFS76240000` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHDFS76240000`, Paper: `HHDFS76240000`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 해외주식 기간별시세.
