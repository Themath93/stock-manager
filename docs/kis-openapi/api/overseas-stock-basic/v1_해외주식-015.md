...
해외주식조건검색 API for [해외주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHDFS76410000` |
| Paper Trading | `HHDFS76410000` |


## Endpoint

```
GET /uapi/overseas-price/v1/quotations/inquire-search
```
...
| `tr_id` | `HHDFS76410000` | Conditional | TR_ID for real trading |
| `tr_id` | `HHDFS76410000` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHDFS76410000`, Paper: `HHDFS76410000`) | Yes |
