...
해외주식 현재체결가 API for [해외주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHDFS00000300` |
| Paper Trading | `HHDFS00000300` |
...
| `tr_id` | `HHDFS00000300` | Conditional | TR_ID for real trading |
| `tr_id` | `HHDFS00000300` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHDFS00000300`, Paper: `HHDFS00000300`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 해외주식 현재체결가.
