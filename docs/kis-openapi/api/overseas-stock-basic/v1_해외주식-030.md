...
해외주식분봉조회 API for [해외주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHDFS76950200` |
...
| `tr_id` | `HHDFS76950200` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHDFS76950200`, Paper: `모의투자 미지원`) | Yes |
