...
해외선물 미결제추이 API for [해외선물옵션] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHDDB95030000` |
...
```
GET /uapi/overseas-futureoption/v1/quotations/investor-unpd-trend
```
...
| `tr_id` | `HHDDB95030000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHDDB95030000`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 해외선물 미결제추이.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/overseas-futureoption/v1/quotations/investor-unpd-trend"
...
[Back to [해외선물옵션] 기본시세](../index.md) | [API Documentation Index](../../index.md)