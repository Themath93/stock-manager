...
해외옵션종목현재가 API for [해외선물옵션] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHDFO55010000` |
...
```
GET /uapi/overseas-futureoption/v1/quotations/opt-price
```
...
| `tr_id` | `HHDFO55010000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHDFO55010000`, Paper: `모의투자 미지원`) | Yes |
