...
지수선물 실시간호가 API for [국내선물옵션] 실시간시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `H0IFASP0` |
...
| `tr_id` | `H0IFASP0` | Conditional | TR_ID for real trading |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 지수선물 실시간호가.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/tryitout/H0IFASP0"
