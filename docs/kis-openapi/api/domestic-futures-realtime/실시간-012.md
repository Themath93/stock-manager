...
선물옵션 실시간체결통보 API for [국내선물옵션] 실시간시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `H0IFCNI0` |
| Paper Trading | `H0IFCNI9` |


## Endpoint

```
POST /tryitout/H0IFCNI0
```
...
| `tr_id` | `H0IFCNI0` | Conditional | TR_ID for real trading |
| `tr_id` | `H0IFCNI9` | Conditional | TR_ID for paper trading |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 선물옵션 실시간체결통보.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/tryitout/H0IFCNI0"
...
[Back to [국내선물옵션] 실시간시세](../index.md) | [API Documentation Index](../../index.md)