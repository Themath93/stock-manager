...
종목조건검색조회 API for [국내주식] 시세분석.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `HHKST03900400` |
...
| `tr_id` | `HHKST03900400` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `HHKST03900400`, Paper: `모의투자 미지원`) | Yes |
