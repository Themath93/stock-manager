...
국내주식 상하한가 포착 API for [국내주식] 시세분석.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST130000C0` |
...
```
GET /uapi/domestic-stock/v1/quotations/capture-uplowprice
```
...
| `tr_id` | `FHKST130000C0` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST130000C0`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 상하한가 포착.
