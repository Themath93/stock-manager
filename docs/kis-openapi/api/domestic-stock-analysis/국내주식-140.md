...
국내주식 시간외예상체결등락률 API for [국내주식] 시세분석.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST11860000` |
...
```
GET /uapi/domestic-stock/v1/ranking/overtime-exp-trans-fluct
```
...
| `tr_id` | `FHKST11860000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST11860000`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 시간외예상체결등락률.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-stock/v1/ranking/overtime-exp-trans-fluct"
