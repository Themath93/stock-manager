...
당사 해외주식담보대출 가능 종목 API for [해외주식] 시세분석.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTLN4050R` |
...
```
GET /uapi/overseas-price/v1/quotations/colable-by-company
```
...
| `tr_id` | `CTLN4050R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTLN4050R`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 당사 해외주식담보대출 가능 종목.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/overseas-price/v1/quotations/colable-by-company"
...
[Back to [해외주식] 시세분석](../index.md) | [API Documentation Index](../../index.md)