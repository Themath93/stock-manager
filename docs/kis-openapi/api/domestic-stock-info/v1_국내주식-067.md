...
주식기본조회 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTPF1002R` |
...
| `tr_id` | `CTPF1002R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTPF1002R`, Paper: `모의투자 미지원`) | Yes |
