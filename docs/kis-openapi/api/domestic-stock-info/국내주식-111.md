...
국내주식 당사 신용가능종목 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHPST04770000` |
...
```
GET /uapi/domestic-stock/v1/quotations/credit-by-company
```
...
| `tr_id` | `FHPST04770000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHPST04770000`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 당사 신용가능종목.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-stock/v1/quotations/credit-by-company"
...
[Back to [국내주식] 종목정보](../index.md) | [API Documentation Index](../../index.md)