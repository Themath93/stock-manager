...
국내주식 손익계산서 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST66430200` |
...
```
GET /uapi/domestic-stock/v1/finance/income-statement
```
...
| `tr_id` | `FHKST66430200` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST66430200`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 손익계산서.
