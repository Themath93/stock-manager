...
국내주식 증권사별 투자의견 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST663400C0` |
...
```
GET /uapi/domestic-stock/v1/quotations/invest-opbysec
```
...
| `tr_id` | `FHKST663400C0` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST663400C0`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 증권사별 투자의견.
