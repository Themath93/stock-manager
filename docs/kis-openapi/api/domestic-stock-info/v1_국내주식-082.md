...
국내주식 기타주요비율 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST66430500` |
...
```
GET /uapi/domestic-stock/v1/finance/other-major-ratios
```
...
| `tr_id` | `FHKST66430500` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST66430500`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 기타주요비율.
