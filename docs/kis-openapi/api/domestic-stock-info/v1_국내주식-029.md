...
상품기본조회 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTPF1604R` |
...
| `tr_id` | `CTPF1604R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTPF1604R`, Paper: `모의투자 미지원`) | Yes |
