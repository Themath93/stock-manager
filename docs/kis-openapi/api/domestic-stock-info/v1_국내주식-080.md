...
국내주식 재무비율 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST66430300` |
...
| `tr_id` | `FHKST66430300` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST66430300`, Paper: `모의투자 미지원`) | Yes |
