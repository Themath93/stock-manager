...
당사 대주가능 종목 API for [국내주식] 종목정보.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTSC2702R` |
...
```
GET /uapi/domestic-stock/v1/quotations/lendable-by-company
```
...
| `tr_id` | `CTSC2702R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTSC2702R`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 당사 대주가능 종목.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-stock/v1/quotations/lendable-by-company"
