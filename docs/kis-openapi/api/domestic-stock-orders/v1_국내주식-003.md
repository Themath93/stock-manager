...
주식주문(정정취소) API for [국내주식] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTC0013U` |
| Paper Trading | `VTTC0013U` |
...
| `tr_id` | `TTTC0013U` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTC0013U` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTC0013U`, Paper: `VTTC0013U`) | Yes |
