...
매수가능조회 API for [국내주식] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTC8908R` |
| Paper Trading | `VTTC8908R` |
...
| `tr_id` | `TTTC8908R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTC8908R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTC8908R`, Paper: `VTTC8908R`) | Yes |
