...
주식잔고조회 API for [국내주식] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTC8434R` |
| Paper Trading | `VTTC8434R` |
...
| `tr_id` | `TTTC8434R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTC8434R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTC8434R`, Paper: `VTTC8434R`) | Yes |
