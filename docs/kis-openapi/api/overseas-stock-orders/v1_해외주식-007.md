...
해외주식 주문체결내역 API for [해외주식] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTS3035R` |
| Paper Trading | `VTTS3035R` |
...
| `tr_id` | `TTTS3035R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTS3035R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTS3035R`, Paper: `VTTS3035R`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 해외주식 주문체결내역.
