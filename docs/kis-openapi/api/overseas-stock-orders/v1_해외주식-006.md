...
해외주식 잔고 API for [해외주식] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTS3012R` |
| Paper Trading | `VTTS3012R` |
...
| `tr_id` | `TTTS3012R` | Conditional | TR_ID for real trading |
| `tr_id` | `VTTS3012R` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTS3012R`, Paper: `VTTS3012R`) | Yes |
