...
해외주식 기간손익 API for [해외주식] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `TTTS3039R` |
...
| `tr_id` | `TTTS3039R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `TTTS3039R`, Paper: `모의투자 미지원`) | Yes |
