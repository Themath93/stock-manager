...
국내주식기간별시세(일/주/월/년) API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST03010100` |
| Paper Trading | `FHKST03010100` |
...
| `tr_id` | `FHKST03010100` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST03010100` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST03010100`, Paper: `FHKST03010100`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식기간별시세(일/주/월/년).
...
[Back to [국내주식] 기본시세](../index.md) | [API Documentation Index](../../index.md)