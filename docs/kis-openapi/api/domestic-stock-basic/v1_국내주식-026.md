...
주식현재가 시간외일자별주가 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHPST02320000` |
| Paper Trading | `FHPST02320000` |
...
| `tr_id` | `FHPST02320000` | Conditional | TR_ID for real trading |
| `tr_id` | `FHPST02320000` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHPST02320000`, Paper: `FHPST02320000`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 주식현재가 시간외일자별주가.
