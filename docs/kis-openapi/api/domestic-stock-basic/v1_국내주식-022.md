...
주식당일분봉조회 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST03010200` |
| Paper Trading | `FHKST03010200` |
...
| `tr_id` | `FHKST03010200` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST03010200` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST03010200`, Paper: `FHKST03010200`) | Yes |
