...
주식현재가 일자별 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST01010400` |
| Paper Trading | `FHKST01010400` |
...
| `tr_id` | `FHKST01010400` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST01010400` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST01010400`, Paper: `FHKST01010400`) | Yes |
