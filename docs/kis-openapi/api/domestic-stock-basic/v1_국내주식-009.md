...
주식현재가 체결 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST01010300` |
| Paper Trading | `FHKST01010300` |
...
| `tr_id` | `FHKST01010300` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST01010300` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST01010300`, Paper: `FHKST01010300`) | Yes |
