...
주식현재가 시세 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST01010100` |
| Paper Trading | `FHKST01010100` |
...
| `tr_id` | `FHKST01010100` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST01010100` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST01010100`, Paper: `FHKST01010100`) | Yes |
