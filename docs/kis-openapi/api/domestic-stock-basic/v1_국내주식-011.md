...
주식현재가 호가/예상체결 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST01010200` |
| Paper Trading | `FHKST01010200` |
...
| `tr_id` | `FHKST01010200` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST01010200` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST01010200`, Paper: `FHKST01010200`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 주식현재가 호가/예상체결.
