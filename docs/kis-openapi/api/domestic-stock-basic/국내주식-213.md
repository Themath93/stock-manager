...
주식일별분봉조회 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST03010230` |
...
| `tr_id` | `FHKST03010230` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST03010230`, Paper: `모의투자 미지원`) | Yes |
