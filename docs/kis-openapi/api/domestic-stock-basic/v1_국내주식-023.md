...
주식현재가 당일시간대별체결 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHPST01060000` |
| Paper Trading | `FHPST01060000` |
...
| `tr_id` | `FHPST01060000` | Conditional | TR_ID for real trading |
| `tr_id` | `FHPST01060000` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHPST01060000`, Paper: `FHPST01060000`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 주식현재가 당일시간대별체결.
