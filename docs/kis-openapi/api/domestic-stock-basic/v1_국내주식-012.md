...
주식현재가 투자자 API for [국내주식] 기본시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST01010900` |
| Paper Trading | `FHKST01010900` |
...
| `tr_id` | `FHKST01010900` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKST01010900` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST01010900`, Paper: `FHKST01010900`) | Yes |
