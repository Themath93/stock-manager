...
업종 분봉조회 API for [국내주식] 업종/기타.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKUP03500200` |
...
| `tr_id` | `FHKUP03500200` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKUP03500200`, Paper: `모의투자 미지원`) | Yes |
