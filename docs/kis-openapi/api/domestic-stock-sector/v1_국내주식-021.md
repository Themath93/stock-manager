...
국내주식업종기간별시세(일/주/월/년) API for [국내주식] 업종/기타.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKUP03500100` |
| Paper Trading | `FHKUP03500100` |
...
| `tr_id` | `FHKUP03500100` | Conditional | TR_ID for real trading |
| `tr_id` | `FHKUP03500100` | Conditional | TR_ID for paper trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKUP03500100`, Paper: `FHKUP03500100`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식업종기간별시세(일/주/월/년).
