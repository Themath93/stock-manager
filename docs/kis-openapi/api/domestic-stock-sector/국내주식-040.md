...
국내휴장일조회 API for [국내주식] 업종/기타.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTCA0903R` |
...
| `tr_id` | `CTCA0903R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTCA0903R`, Paper: `모의투자 미지원`) | Yes |
