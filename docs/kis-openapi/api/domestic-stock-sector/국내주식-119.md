...
국내업종 시간별지수(분) API for [국내주식] 업종/기타.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHPUP02110200` |
...
```
GET /uapi/domestic-stock/v1/quotations/inquire-index-timeprice
```
...
| `tr_id` | `FHPUP02110200` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHPUP02110200`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내업종 시간별지수(분).

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-stock/v1/quotations/inquire-index-timeprice"
...
[Back to [국내주식] 업종/기타](../index.md) | [API Documentation Index](../../index.md)