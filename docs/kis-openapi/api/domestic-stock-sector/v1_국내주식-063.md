...
국내업종 현재지수 API for [국내주식] 업종/기타.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHPUP02100000` |
...
| `tr_id` | `FHPUP02100000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHPUP02100000`, Paper: `모의투자 미지원`) | Yes |
