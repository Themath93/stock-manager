...
일반채권 실시간체결가 API for [장내채권] 실시간시세.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `H0BJCNT0` |
...
| `tr_id` | `H0BJCNT0` | Conditional | TR_ID for real trading |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 일반채권 실시간체결가.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/tryitout/H0BJCNT0"
...
[Back to [장내채권] 실시간시세](../index.md) | [API Documentation Index](../../index.md)