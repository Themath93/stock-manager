...
채권정정취소가능주문조회 API for [장내채권] 주문/계좌.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `CTSC8035R` |
...
```
GET /uapi/domestic-bond/v1/trading/inquire-psbl-rvsecncl
```
...
| `tr_id` | `CTSC8035R` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `CTSC8035R`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 채권정정취소가능주문조회.

    Returns:
        Dict[str, Any]: API response data
    """
    url = f"{BASE_URL}/uapi/domestic-bond/v1/trading/inquire-psbl-rvsecncl"
...
[Back to [장내채권] 주문/계좌](../index.md) | [API Documentation Index](../../index.md)