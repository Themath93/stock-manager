...
국내주식 신용잔고 상위 API for [국내주식] 순위분석.

## TR_ID Information

| Environment | TR_ID |
|-------------|-------|
| Real Trading | `FHKST17010000` |
...
```
GET /uapi/domestic-stock/v1/ranking/credit-balance
```
...
| `tr_id` | `FHKST17010000` | Conditional | TR_ID for real trading |
...
|-----------|------|-------------|----------|
| `tr_id` | string | TR_ID (Real: `FHKST17010000`, Paper: `모의투자 미지원`) | Yes |
...
def make_api_request() -> Dict[str, Any]:
    """
    Make API request to 국내주식 신용잔고 상위.
